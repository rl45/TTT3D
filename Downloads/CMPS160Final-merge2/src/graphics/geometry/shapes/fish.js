 ...
 * @this {LoadedOBJ}
 */
class FishOBJ extends Geometry {
    /**
     ...
     */
    constructor(shader, objStr, image, size) {
        super(shader);
        this.image = image;
        this.size = size;
     ...
     */
    addVertexPoints(indices, points, size) {
        ...
        for (var i = 0; i < indices.length; i++) {
            var index = indices[i];
            var xyz = [points[index * 3] * size, points[index * 3 + 1] * size, points[index * 3 + 2]* size];
