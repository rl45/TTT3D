...
class CustomOBJ extends Geometry {
  ...
  constructor(shader, objStr, image) {
    ...
    this.scaleMatrix.setScale(.4,.4,.4);
  ...
  updateValue(x,y,z){
    ...
    //this.shader.setUniform("u_ViewMatrix", this.viewMatrix.elements);

  }


  /*updateViewMatrix(e0, e1, e2, c0, c1, c2, u0, u1, u2){
    //this.viewMatrix = new Matrix4();
    //this.viewMatrix.setLookAt(e0, e1, e2,c0, c1, c2, u0, u1, u2);
    this.modelMatrix.setLookAt(e0, e1, e2,c0, c1, c2, u0, u1, u2);
  ...
  attack(){
    ...
    //this.translationMatrix = new Matrix4();
    this.rotationMatrix.setRotate(90, customX, customY+20, customZ);
    //this.translationMatrix.setTranslate(.2, .2, .2);
    this.modelMatrix.multiply(this.rotationMatrix);
    this.translationMatrix.multiply(this.rotationMatrix);
    //his.modelMatrix.multiply(this.translationMatrix);
